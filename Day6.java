public class Day6 {
    public static void main () {
        ...
        for(String in:input) {
            String instruction;
            int index;
            if(in.substring(0,in.indexOf(" ")).equals("turn")) {
                index = in.indexOf(" ",in.indexOf(" ")+1);
                instruction = in.substring(0,index);
            } else {
                index = in.indexOf(" ");
                instruction = in.substring(0,index);
            }
            ...
            startx = Integer.parseInt(in.substring(index,in.indexOf(",",index)));
            index = in.indexOf(",",index)+1;
            starty = Integer.parseInt(in.substring(index,in.indexOf(" ",index)));
            index = in.indexOf(" ",in.indexOf(" ",index)+1)+1;
            endx = Integer.parseInt(in.substring(index,in.indexOf(",",index)));
            index = in.indexOf(",",index)+1;
            endy = Integer.parseInt(in.substring(index));
