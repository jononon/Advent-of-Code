public class Day2 {
    public static void main () {
        ...
        for (String dimension:dimensions) {
            ...
            int side2 = height*width;
            int side3 = height*length;
            int area = 2*side1 + 2*side2 + 2*side3 + min(side1,side2,side3);
            System.err.println(dimension+": "+area+","+side1+","+side2+","+side3);
            totalSquareFeet += area;
            
            totalRibbonLength += minPerimeter(length,width,height)+length*width*height;
        }
        System.out.println(totalSquareFeet);
        System.out.println(totalRibbonLength);
    }
    
    public static int min (int area1, int area2, int area3) {
    ...
    public static int minPerimeter (int in1, int in2, int in3) {
        int[] ordered = {in1, in2, in3};
        int temp;
        for (int p=3;p>0;p--) {
